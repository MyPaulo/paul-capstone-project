       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="navbar-header"><!-- navbar-header Begin -->
               ...
               <a href="index.php" class="navbar-brand home"><!-- navbar-brand home Begin -->
                   ...
                   <img src="images/Shopomobile.png" alt="Paulo-Store Logo Mobile" class="visible-xs">
                                  ...
                                  <?php 
                                   ...
                                   <tr><!-- tr Begin -->
                                       ...
                                       <td>
                                           ...
                                           <img class="img-responsive" src="admin_page/product_images/<?php echo $product_img1; ?>" alt="<?php echo $product_img1; ?>">
                       ...
                       <div class="box-footer"><!-- box-footer Begin -->
                           ...
                           <div class="pull-right"><!-- pull-right Begin -->
                               ...
                               <button type="submit" name="update" value="Update Cart" class="btn btn-default"><!-- btn btn-default Begin -->
                                   ...
                                   <i class="fa fa-refresh"></i> Remove (items)
