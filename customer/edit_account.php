...
<form action="" method="post" enctype="multipart/form-data"><!-- form Begin -->
    ...
    <div class="form-group"><!-- form-group Begin -->
        ...
        <input type="tel" pattern="^(\+0?1\s)?\(?\d{3}\)?[\s.-]\d{3}[\s.-]\d{4}$" name="c_contact" class="form-control" value="<?php echo $customer_contact; ?>" required>
...
if(isset($_POST['update'])){
    ...
    if($run_customer){
        ...
        echo "<script>alert('Account Updated! Please Relogin')</script>";
