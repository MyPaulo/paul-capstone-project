    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Portal / Update Manufacturer
                ...
                <form action="" class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal begin -->
                    ...
                    <div class="form-group"><!-- form-group 3 begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                          ...
                          <img width="70" height="70" src="manu_images/<?php echo $m_image; ?>" alt="<?php echo $m_image; ?>">
    ...
    if(isset($_POST['update'])){
        ...
        if(is_uploaded_file($_FILES['manufacturer_image']['tmp_name'])){
            ...
            if($run_manufacturer){
                ...
                echo "<script>alert('Manufacturer updated succesfully')</script>";
