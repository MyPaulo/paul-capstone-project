    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Portal / Add Manufacturer
...
<?php  
    ...
    if(isset($_POST['submit'])){
        ...
        move_uploaded_file($temp_name,"manu_images/$manufacturer_image");
        ...
        echo "<script>alert('New Manufacturer Added succesfully')</script>";
